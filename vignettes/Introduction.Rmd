...
```{r}
dnorm <- cal.dnorm(dat.list, subsample = TRUE, n.subsample = 1000, seed = NULL)
```

```{r}
res <- cal.modality.weights(dat.list, cell.type, q = 2, dnorm, subsample = TRUE, n.subsample = 200, seed = NULL)
```
